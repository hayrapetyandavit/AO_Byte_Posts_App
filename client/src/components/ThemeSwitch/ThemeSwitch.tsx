...
const ThemeSwitch: FC<IProps> = (props) => {
  return (
    <label className={classes.themeToggleButton} title="Theme Switch">
      <input
        type="checkbox"
      ...
      >
        ...
        >
          ...
          <g transform="translate(2.333 2.333)" className={classes.button}>
            <g data-name="sun" className={classes.sun}>
              <g
            ...
            <g data-name="moon" className={classes.moon}>
              <g
                filter="url(.moon)"
